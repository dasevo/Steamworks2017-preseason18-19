...
public class Robot extends TimedRobot {
	...
	public static Accelerate accelerate = new Accelerate();
	public static DriveToDistance_Subsystem driveToDistance = new DriveToDistance_Subsystem();
	...
	static MyVisionPipeline pipeline = new MyVisionPipeline();
	GripValues visionValues = new GripValues();
...
//	public static DriveToDistance_Subsystem driveToDist = new DriveToDistance_Subsystem();
	...
	public void robotInit() //starts once when the code is started
	{
		...
		new Thread(() -> {
			...
			{
//				toProcess = cvSink.grabFrame(source); //hopefully, this will not cause the video to drop to half the framerate ->if so, try changing own source
...
*/		//if working, implement some calculations that will do Pythagorean theorem to find heading and distance
	}
