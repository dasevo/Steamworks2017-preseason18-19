...
public class Constants 
{
	...
	public static final double kProt = 0.03; //constant P
	public static final double kIrot = 0.0; //constant I
	public static final double kDrot = 0.0; //constant D
	public static final double kFrot = 0.0; // constant F
	public static final double kTolerance = 2.0f; //tolerance of degrees
	
	public static final double kPdist = 0.15;
	public static final double kIdist = 0;
	public static final double kDdist = 0;
	public static final double kFdist = 0;
	public static final double toleranceIn = 1;
	public static final double ticksPerRotation = 1040;
	...
	public static final double accRatio = 0.02;
	public static final double accRatioTeleop = 0.1;
}
