...
{	
	...
	public boolean getAutoLess()
	{
		return autoLess;
	}
	
	public void setAutoLess(boolean autoLess)
	{
		this.autoLess = autoLess; 
	}
	...
	public MecanumDrive robotDrive = new MecanumDrive(RobotMap.frontLeft, RobotMap.backLeft, RobotMap.frontRight, RobotMap.backRight);
