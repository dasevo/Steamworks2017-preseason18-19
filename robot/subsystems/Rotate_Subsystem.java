...
public class Rotate_Subsystem extends Subsystem implements PIDOutput
{
	...
	public void pidWrite(double output)
	{
		if(rotateToAngle)
		{
//			Robot.driveExecutor.setZ(output*Robot.accelerate.accelerate(0.6, Robot.driveExecutor.getZ())); //set the speed of the rotation to .6
			Robot.driveExecutor.setZ(output*0.6);
		}
	}
