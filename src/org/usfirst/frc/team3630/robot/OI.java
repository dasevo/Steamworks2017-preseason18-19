...
public class OI {
	...
	private final Button buttonA = new JoystickButton(controller, aButton);
	private final Button buttonB = new JoystickButton(controller, bButton);
	private final Button buttonX = new JoystickButton(controller, xButton);
	private final Button buttonY = new JoystickButton(controller, yButton);
	private final Button bumperL = new JoystickButton(controller, leftBumper);
	private final Button bumperR = new JoystickButton(controller, rightBumper);
	private final Button backB = new JoystickButton(controller, backButton);	
	...
	public OI()
	{
		buttonA.toggleWhenPressed(new SafeDrive_Command()); //enables safe mode - I hope that this is the way how it works
	}
	...
	public double deadzone(double input)
	{
		...
		//low values of x,y,z are ignored
	}
